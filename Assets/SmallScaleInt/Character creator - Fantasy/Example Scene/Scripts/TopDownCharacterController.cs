...
namespace SmallScaleInc.CharacterCreatorFantasy
{
    ...
    void Update()
    {
        ...
        bool walkHold = Input.GetKey(KeyCode.LeftControl);
        ...
        if (Input.GetKeyDown(KeyCode.Alpha1)) { animator.SetTrigger("Attack2"); OnTriggerFired?.Invoke("Attack2"); }
        if (Input.GetKeyDown(KeyCode.Alpha2)) { animator.SetTrigger("Attack1"); OnTriggerFired?.Invoke("Attack1"); }
        if (Input.GetKeyDown(KeyCode.Alpha3)) { animator.SetTrigger("Attack4"); OnTriggerFired?.Invoke("Attack4"); }
        if (Input.GetKeyDown(KeyCode.Alpha4)) { animator.SetTrigger("Attack5"); OnTriggerFired?.Invoke("Attack5"); }
        if (Input.GetKeyDown(KeyCode.Alpha5)) { animator.SetTrigger("Special1"); OnTriggerFired?.Invoke("Special1"); }
        if (Input.GetKeyDown(KeyCode.Alpha6)) { animator.SetTrigger("Special2"); OnTriggerFired?.Invoke("Special2"); }
        if (Input.GetKeyDown(KeyCode.Alpha7)) { animator.SetTrigger("Taunt");    OnTriggerFired?.Invoke("Taunt"); }
        if (Input.GetKeyDown(KeyCode.Alpha8)) { animator.SetTrigger("Die");      OnTriggerFired?.Invoke("Die"); }
        if (Input.GetKeyDown(KeyCode.Alpha9)) { animator.SetTrigger("TakeDamage");OnTriggerFired?.Invoke("TakeDamage"); }
